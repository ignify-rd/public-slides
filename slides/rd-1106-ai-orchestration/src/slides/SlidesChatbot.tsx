  ...
  return (
    <SlideWrapper className="relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col flex-1 min-h-0">
        <h2 className="text-3xl font-extrabold text-gray-900 mb-3">Hình thái đầu tiên của LLM - AI</h2>
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-auto">
            <p className="text-sm font-bold text-amber-700 uppercase mb-1">Giới hạn</p>
            <p className="text-base text-amber-800">Không thể tự chủ hành động - chỉ phản hồi, không chủ động xử lý công việc phức tạp.</p>
          </div>
        </div>
      </div>
    </SlideWrapper>
