  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Git can ban{' '}
          <span style={{ color: theme.colors.accent }}>cho Developer</span>
        </motion.h1>
        ...
        >
          Huong dan thuc te su dung Git danh cho fresher va junior developer - tu khoi tao den quy trinh lam viec chuyen nghiep.
        </motion.p>
      </motion.div>
